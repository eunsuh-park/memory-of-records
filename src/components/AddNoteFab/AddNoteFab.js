...
/* 노트 표지 색상 이름 → 스와치 색. 한글 라벨과 1:1, 선명한 값 (테마 토큰 아님) */
const COLOR_CHIP_HEX = {
  ...
  남색: '#1B3A8A',
  회색: '#8E8E93',
  무지개: 'linear-gradient(135deg,#FF3B30 0%,#FF9500 20%,#FFCC00 40%,#34C759 60%,#2F6BFF 80%,#AF52DE 100%)',
  흰색: '#FFFFFF',
  검정: '#111111',
  자주: '#C2185B'
};
...
const LIGHT_COLOR_NAMES = ['흰색', '노랑', '연두', '하늘'];
