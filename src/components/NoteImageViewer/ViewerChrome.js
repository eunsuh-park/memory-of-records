 ...
 *  - 하단 시트 액션  : 2페이지 토글 + 정보·추가·북마크·공유를 한 열로 묶음
 *  - 시트 아이콘     : circle S · role toolbar · tone ghost
 *
...
/** 2페이지 보기 토글 (BookFlip3D). 하단 시트 액션 열 맨 위 */
